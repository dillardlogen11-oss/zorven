(() => {
  ...
  function setView(view) {
    ...
    elements.directMessageRecipient.hidden = !showingDirectMessages;
    elements.input.disabled = showingDirectMessages ? false : !activeChannel;
